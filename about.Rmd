...
body {
    ...
    color:#ffffff;
    background: -webkit-gradient(linear, center top, center bottom, from  (#0f3443), to(#34e89e)) fixed;
    background: -webkit-linear-gradient                                   (#0f3443, #34e89e) fixed;
    background: -moz-linear-gradient                                      (#0f3443, #34e89e) fixed;
    background: -o-linear-gradient                                        (#0f3443, #34e89e) fixed;
    background: -ms-linear-gradient                                       (#0f3443, #34e89e) fixed;
    background: linear-gradient                                           (#0f3443, #34e89e) fixed;
}
</style>
</head>
