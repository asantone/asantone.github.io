...
body {
    ...
    background: -webkit-linear-gradient(#be3c5a, #fabe73);
    background: -moz-linear-gradient(#be3c5a, #fabe73);
    background: -o-linear-gradient(#be3c5a, #fabe73);
    background: -ms-linear-gradient(#be3c5a, #fabe73);
    background: linear-gradient(#be3c5a, #fabe73);
}
</style>
</head>
